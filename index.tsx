    ...
    articles: [
        {
            ...
            content: `عاد الجدل من جديد حول ملف "ليونة سعر صرف الدرهم" أو ما يعرف بـ "التعويم"، وهو قرار استراتيجي ينهجه بنك المغرب تدريجياً منذ سنوات. هذا التحول من نظام سعر صرف ثابت إلى نظام أكثر مرونة يثير تساؤلات مشروعة حول تأثيره على استقرار الأسعار والقدرة الشرائية للمغاربة.

أولاً: ما هو تعويم الدرهم؟
التعويم يعني جعل قيمة الدرهم تتحدد بناءً على قانون العرض والطلب في سوق العملات، بدلاً من ربطه بسلة عملات ثابتة (الأورو والدولار). المغرب اختار "التعويم التدريجي" لتفادي الصدمات العنيفة التي شهدتها دول أخرى، حيث يتم توسيع نطاق تقلب العملة بشكل مدروس وتحت مراقبة دقيقة من والي بنك المغرب.

ثانياً: الإيجابيات والمكاسب الاقتصادية
1. تعزيز التنافسية الخارجية: عندما تنخفض قيمة العملة محلياً، تصبح المنتجات المغربية (مثل السيارات، الفوسفاط، والمنتجات الفلاحية) أرخص في الأسواق الدولية، مما يرفع من حجم الصادرات.
2. جذب الاستثمارات الأجنبية: المرونة في سعر الصرف تعطي طمأنينة للمستثمرين الدوليين بأن الاقتصاد المغربي منفتح وشفاف ويخضع لمعايير السوق العالمية.
3. حماية احتياطي العملة الصعبة: يساعد النظام المرن في امتصاص الصدمات الخارجية دون استنزاف احتياطيات البلاد من العملات الأجنبية للدفاع عن قيمة ثابتة للدرهم.

ثالثاً: السلبيات والمخاطر المحتملة
1. ارتفاع فاتورة الاستيراد: المغرب يستورد معظم حاجياته الطاقية (البترول والغاز) والعديد من المواد الأولية بالدولار. أي انخفاض في قيمة الدرهم سيعني آلياً ارتفاع تكلفة هذه المواد، مما قد يؤدي إلى موجة غلاء جديدة.
2. التضخم المستورد: انتقال ارتفاع تكاليف الاستيراد إلى أسعار الاستهلاك النهائي سيثقل كاهل المواطن، خاصة في ظل تقلبات أسعار الطاقة العالمية.
3. المديونية الخارجية: ارتفاع قيمة العملات الأجنبية مقابل الدرهم يزيد من ثقل الديون الخارجية للمغرب عند تقويمها بالعملة الوطنية، مما قد يضغط على ميزانية الدولة.

رابعاً: هل الوقت مناسب؟
يؤكد الخبراء أن نجاح التعويم رهين بصلابة المقاولات المغربية وقدرتها على التصدير، وكذا بمدى تحكم البنك المركزي في مستويات التضخم. المغرب يتوفر حالياً على "وسادة أمان" متمثلة في احتياطيات مهمة من العملة الصعبة واستقرار سياسي وماكرو-اقتصادي يجعل منه استثناءً إقليمياً.

خلاصة القول، إن تعويم الدرهم هو "دواء مر" لابد منه للاندماج في الاقتصاد العالمي، لكنه يتطلب يقظة دائمة وسياسات مواكبة لحماية الفئات الهشة من تداعيات تقلبات الأسعار. يبقى الهدف الأسمى هو تحويل المغرب إلى قطب مالي دولي قادر على منافسة الكبار.`,
        ...
        },
        {
            ...
            content: `استبشر المغاربة خيراً بالتساقطات المطرية والثلجية الكثيفة التي شهدتها مختلف أقاليم المملكة خلال الأيام الماضية. هذه "الأمطار الذهبية" لم تروِ عطش الأرض فحسب، بل أعطت دفعة قوية للروح المعنوية للفلاحين والمستثمرين، ورسمت معالم تفاؤل كبير بخصوص الأداء الاقتصادي للمغرب في سنة 2025...`,
        ...
        },
        {
            ...
            content: `شهدت الأسواق المغربية خلال الأسابيع الأخيرة تحولاً إيجابياً أسعد ملايين الأسر، حيث سجلت أسعار زيت الزيتون انخفاضاً ملحوظاً بعد موجة غلاء استمرت لأكثر من سنتين. هذا التراجع يأتي نتيجة تضافر عدة عوامل مناخية وتقنية ساهمت في وفرة المحصول الوطني لهذا الموسم...`,
