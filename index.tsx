...
const getShareButtonsHtml = (title: string, id: string, compact = false) => {
    ...
    return `<div class="viral-box bg-white dark:bg-gray-900 border-2 border-gray-100 dark:border-gray-800 rounded-[2rem] p-6 text-center my-8">
        ...
        <div class="flex flex-wrap justify-center gap-3">
            ...
            <a href="https://twitter.com/intent/tweet?text=${encodedTitle}&url=${encodedUrl}" target="_blank" class="bg-black text-white px-5 py-2.5 rounded-xl font-black text-xs hover:opacity-90 transition shadow-lg">تويتر X</a>
            <a href="https://t.me/share/url?url=${encodedUrl}&text=${encodedTitle}" target="_blank" class="bg-[#0088cc] text-white px-5 py-2.5 rounded-xl font-black text-xs hover:opacity-90 transition shadow-lg">تليجرام</a>
        </div>
    </div>`;
};
